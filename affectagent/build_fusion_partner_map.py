...
def parse_args():
    parser = argparse.ArgumentParser(description="Build AffectAgent perceptual fusion-partner map")
    ...
    parser.add_argument(
        "--output-path",
        type=str,
        default="affectagent/artifacts/sft_data/fusion_partner_map.json",
...
def main():
    ...
    retriever = DualChannelRetriever(multimodal_index_dir=args.multimodal_index_dir)
