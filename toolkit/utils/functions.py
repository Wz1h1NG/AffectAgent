...
def func_translate_transcript(trans_path, save_path):
    from toolkit.utils.chatgpt import get_translate_eng2chi
...
def func_calculate_emotion_similarity():
    ...
    model_path = os.environ.get('AFFECTAGENT_WORD2VEC_PATH', '')
    if not model_path:
        raise RuntimeError('Set AFFECTAGENT_WORD2VEC_PATH before running this optional utility.')
