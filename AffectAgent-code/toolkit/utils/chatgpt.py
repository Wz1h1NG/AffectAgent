...
candidate_keys = [
    key.strip()
    for key in os.environ.get("OPENAI_API_KEYS", os.environ.get("OPENAI_API_KEY", "")).split(",")
    if key.strip()
]
if not candidate_keys:
    candidate_keys = [None]
if candidate_keys[global_index]:
...
if __name__ == '__main__':
    ...
    ## video input [test ok]
    # video_paths = ["/path/to/sample_1.mp4", "/path/to/sample_2.mp4"]
